/* tslint:disable */
window.Blockly.Msg.SAP_CALL_METHOD = 'Call method';
window.Blockly.Msg.SAP_CALL_METHOD_TOOLTIP = 'BlockType: sap_call_method';
window.Blockly.Msg.SAP_CALL_METHOD_CONTAINER_TITLE_ADD = 'Method';
window.Blockly.Msg.SAP_CALL_METHOD_CONTAINER_TOOLTIP = 'Add or remove method params';
window.Blockly.Msg.SAP_CALL_METHOD_PARAM_CONTAINER_TITLE = 'Param';
window.Blockly.Msg.SAP_CALL_METHOD_PARAM_CONTAINER_TOOLTIP = 'Add an param to the call method';
window.Blockly.Msg.SAP_CALL_METHOD_HELPURL =
    'https://n.sbis.ru/article/066c8e83-516e-4638-9426-7865a1df28bc';

window.Blockly.Blocks.sap_call_method = {
    /**
     * Block for creating a list with any number of elements of any type.
     * @this {window.Blockly.Block}
     */
    init() {
        this.setHelpUrl(window.Blockly.Msg.SAP_CALL_METHOD_HELPURL);
        this.setStyle('SAP');
        ...
        this.setTooltip(window.Blockly.Msg.SAP_CALL_METHOD_TOOLTIP);
    },
    /**
    ...
    updateShape_() {
        if (!this.getInput('EMPTY')) {
            this.appendDummyInput('EMPTY')
                .appendField(window.Blockly.Msg.SAP_CALL_METHOD)
...
window.Blockly.Blocks.sap_call_method_container = {
    ...
    init() {
        ...
        this.appendDummyInput().appendField(window.Blockly.Msg.SAP_CALL_METHOD_CONTAINER_TITLE_ADD);
        this.appendStatementInput('STACK');
        this.setTooltip(window.Blockly.Msg.SAP_CALL_METHOD_CONTAINER_TOOLTIP);
...
window.Blockly.Blocks.sap_call_method_param = {
    ...
    init() {
        ...
        this.appendDummyInput().appendField(
            window.Blockly.Msg.SAP_CALL_METHOD_PARAM_CONTAINER_TITLE
        );
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setTooltip(window.Blockly.Msg.SAP_CALL_METHOD_PARAM_CONTAINER_TOOLTIP);
        this.contextMenu = false;
    },
};
