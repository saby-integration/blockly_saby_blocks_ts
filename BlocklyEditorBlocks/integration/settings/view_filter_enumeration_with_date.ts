...
const blockId_ = 'view_filter_enumeration_with_date';
window.Blockly.Blocks[blockId_] = {
    ...
    beforeInit_ () {
        ...
        this.appendDummyInput('INFO')
            .appendField('Оформление. Фильтр. Перечисление с условием на дату');
    ...
    updateParam_ (i) {
        ...
        switch (paramType) {
            case 'view_filter_enumeration_with_date_param_item':
